...
// 组件
import GetLearningMaterial from './components/GetLearningMaterial.vue' //导航
...
export default {
	...
	enhanceApp({ app, router }) {
		// 注册全局组件
		app.component('GetLearningMaterial', GetLearningMaterial)
		...
		if (typeof window !== 'undefined') {
			watch(
				...
				() => updateHomePageStyle(location.pathname === BASE_PATH),
				{ immediate: true }
			)
		}
	},
